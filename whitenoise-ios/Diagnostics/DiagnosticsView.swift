...
struct DiagnosticsView: View {
    ...
    static func performanceSnapshotText(_ snapshot: AppPerformanceSnapshotFfi) -> [String] {
        let operations: [(String, AppPerformanceOperationSnapshotFfi)] = [
            ...
            ("inbound delivery projection", snapshot.inboundDeliveryProjection),
            ("outbound message queue", snapshot.outboundMessageQueueWait),
            ("outbound local projection", snapshot.outboundMessageLocalProjection),
            ("outbound local accept", snapshot.outboundMessageLocalAccept),
            ("outbound publish", snapshot.outboundMessagePublish),
            ("outbound response", snapshot.outboundMessageResponse),
            ("outbound bubble visible", snapshot.hostOutboundMessageVisible),
            ("inbound bubble visible", snapshot.hostInboundMessageVisible),
