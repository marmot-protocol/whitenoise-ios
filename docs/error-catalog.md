...
| `FollowListUnavailable` | current account follow list is unavailable | Your contact list is unavailable from relays. Check your connection and relay settings, then try again. No contacts were changed. | [crates/marmot-uniffi/src/errors.rs:77](https://github.com/marmot-protocol/mdk/blob/fdd398a80f1626f1713787cebe416f7890b5b204/crates/marmot-uniffi/src/errors.rs#L77) |
